...
const contactItems = [
  { icon: Phone, label: 'WhatsApp', href: 'https://wa.me/6285213081416?text=AKU%20PENDUKUNG%20ISRAEL%20DAN%20AKU%20BANGGA%20%23LARPINGFINALBOS%23AKUTRIPLECLAH', text: 'AKU PENDUKUNG ISRAEL DAN AKU BANGGA #LARPINGFINALBOS#AKUTRIPLECLAH' },
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-md' : 'bg-transparent'}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-3 sm:gap-4">
            ...
            >
              {dark ? <Sun className="text-yellow-500" /> : <Moon className="text-gray-700" />}
            </button>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            {contactItems.map((item) => (
              ...
              >
                <item.icon className="text-2xl flex-shrink-0 text-gray-600 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" />
