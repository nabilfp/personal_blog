  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="decor" aria-hidden="true">
        <img src="assets/el/opt_star-a-v2.webp" alt="" className="el el--star-b" decoding="async" />
        ...
        <img src="assets/el/opt_star-a-v2.webp" alt="" className="el el--star-b2" decoding="async" />
      </div>
